    ...
    <div className='absolute md:bottom-2 bottom-5 left-0 w-full'>
      <div className="container">
        <div className='flex justify-between md:flex-row flex-col gap-4 items-center'>
          ...
          className='md:absolute md:top-[-250px] md:right-[50px] flex gap-4 items-center text-white md:flex-col'>
            <div className="md:absolute md:bottom-[-60px] md:h-[2px] md:w-[80px] md: bg-primary-color md:rotate-[90deg] md:rounded"></div>
            {SOCIAL_ICONS.map((icon, index) => (
              <div className="p-[5px] border-[2px] rounded-[50%] border-primary-color hover:text-primary-color transition-all ease-in-out">
