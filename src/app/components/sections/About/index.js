  ...
  return (
    <section name="About" className="element">
      <div className="container overflow-hidden">
        ...
        >
          {/* ==== About Content ==== */}
          <motion.div variants={content} className="flex-1 opacity-0">
            {/* ==== Section Title ==== */}
            <SectionTitle
              title={title}
              subtitle={`Expert in`}
            ...
            {/* ==== Services ==== */}
            <motion.div className="flex flex-col md:flex-row items-center flex-wrap justify-between">
          ...
          <motion.div
            ...
            className="hidden relative top-12 md:flex justify-end items-center w-[35%] overflow-hidden"
          >
